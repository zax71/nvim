# Based off https://primamateria.github.io/blog/neovim-nix/
{
  ...
  outputs =
    ...
    let
      overlayFlakeInputs = prev: final: { neovim = neovim.packages.x86_64-linux.neovim; };

      overlayMyNeovim = prev: final: { zax-neovim = import ./packages/zax-neovim.nix { pkgs = final; }; };
